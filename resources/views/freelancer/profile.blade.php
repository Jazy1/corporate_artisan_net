...
@section('title', 'Profile | Freelancer')
                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route('freelancers.profile') }}">
                                        <span>Profile</span>
                                    </a>
                                </li>
                        ...
                        <div class="card__container">
                            <div class="card__header">
                                <div class="card__header-left">
                                    <h3 class="card__header-title">Freelancer Info</h3>
                                </div>
                            ...
                            <div class="card__body">
                                ...
                                <div class="customer-profile__avatar" style="overflow: hidden">
                                    <img src="{{ asset($freelancer->img ) }}" alt="" style="border-radius: 10px;height: -webkit-fill-available;">
                                ...
                                <h4 class="customer-profile__title">{{ $freelancer->name }}</h4>
                                ...
                                <div class="card__container">
                                    <ul class="customer-profile__address">
                                        <li>
                                            ...
                                            </svg> <a href="mailto:#">{{ $freelancer->email }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="modal__wrap">
                                    <div class="modal__window">
                                        <div class="modal__content">
                                            ...
                                            <form method="POST" action="{{ route("freelancers.update", $freelancer->id) }}" id="infoForm" enctype="multipart/form-data">
                                                @csrf
                                                @method("PUT")
                                                <div class="modal__body">
                                                    <div class="modal__container">
                                                        <div class="modal-account__upload profile-upload js-profile-upload">
                                                            ...
                                                            <svg class="profile-upload__thumbnail" viewBox="0 0 252 272" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                                ...
                                                                <defs>
                                                                    ...
                                                                    <image id="profileImageAddPlaceholder" width="700" height="700" xlink:href="  {{ asset($freelancer->img ) }}"></image>
                                                                    <image id="profileImageAdd" class="profile-upload__image" width="700" height="700" xlink:href="{{ asset($freelancer->img ) }}"></image>
                                                                </defs>
                                                            </svg>
                                                        ...
                                                        <div class="space-upNdown input-group input-group--white input-group--prepend">
                                                            ...
                                                            <input class="input" type="text" name="name" value="{{ $freelancer->name }}" placeholder="Name">
                                                        </div>
                                                        ...
                                                        <div class=" space-upNdown input-group input-group--white input-group--prepend">
                                                            ...
                                                            <input class="input" type="email" name="email" value="{{$freelancer->email }}" placeholder="Email" >
                                                        </div>
                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <div class="modal__wrap">
                                    <div class="modal__window">
                                        <div class="modal__content">
                                            <div class="modal__body">
                                                <form id="bankAccountForm" action="{{ route("freelancers.bank_account.update", ['id' => $freelancer->id]) }}" method="POST">
                                                    @method("PUT")
                                                    @csrf
