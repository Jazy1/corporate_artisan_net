...
@section('title', 'Create a Gig | Freelancer')
    ...
    <main class="page-content">
        <div class="container">
            ...
            <div class="page-header">
                <h1 class="page-header__title">Create a Gig</h1>
            </div>
                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route('freelancers.gigs.create') }}">
                                        <span>Create</span>
                                    </a>
                                </li>
            ...
            <div class="card add-product card--content-center">
                <div class="card__wrapper">
                        <div class="card__container">
                            <form class="add-product__form" method="POST" action="{{ route("freelancers.gigs.store") }}" id="myForm" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="row row--md">
                                            ...
                                            <div class="col-12 form-group form-group--lg">
                                                ...
                                                <div class="input-group">
                                                    <input class="input" type="text" placeholder="Gig Title" name="title" value="" required="">
                                                </div>
                                                <br>
