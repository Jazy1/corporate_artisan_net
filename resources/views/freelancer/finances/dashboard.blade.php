...
@section('title', 'Finances | Freelancer')
            ...
            <section class="section">
                ...
                <div class="row gutter-bottom-xl">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 d-flex" style="flex-direction: column;">
                        <a href="{{ route("freelancers.finances.withdraw") }}" class="button button--secondary" type="button">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 d-flex" style="flex-direction: column;">
                        <a href="{{ route("freelancers.profile") }}" class="button button--secondary" type="button">
                            <span class="button__icon button__icon--left">
