...
@section('title', 'Withdraw Money | Freelancer')
                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route("freelancers.finances.index") }}">
                                        <span>Finances</span>
                                    </a>
                                    <svg class="icon-icon-keyboard-right breadcrumbs__arrow">
                                        <use xlink:href="#icon-keyboard-right"></use>
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route("freelancers.finances.withdraw") }}">
                                        <span>Withdraw </span>
                                    </a>
                                </li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            withdrawButton.addEventListener('click', function () {
                ...
                fetch("{{ route('freelancers.finances.withdrawCash') }}", {
                    method: 'POST',
                    headers: {
                ...
                .then(result => {
                    ...
                    setTimeout(function () {
                        window.location.href = "{{ route('freelancers.finances.index') }}";
