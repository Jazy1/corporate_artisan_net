...
@section('title', 'Freelaners | Admin')
                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route('admin.freelancers.index') }}">
                                                ...
                                                @foreach ($freelancers as $freelancer)
                                                    <tr class="table__row">
                                                        ...
                                                        <td class="d-none d-lg-table-cell table__td">
                                                            <span class="text-grey">#{{ $freelancer->id }}</span>
                                                        </td>
                                                        
                                                        <td class="table__td">{{ $freelancer->name }}</td>

                                                        <td class="d-none d-sm-table-cell table__td">
                                                            <span class="text-grey">{{ $freelancer->email }}</span>
                                                        </td>

                                                        <td class="table__td">
                                                            <span>{{ $freelancer->about }}</span>
                                                        </td>

                                                        <td class="table__td text-nowrap">
                                                            <span class="text-grey">{{ \Carbon\Carbon::parse($freelancer->created_on)->format('jS F Y') }}</span>
                                                        </td>
                                                                    ...
                                                                    <div class="dropdown-items__container">
                                                                        <ul class="dropdown-items__list">
                                                                            <li class="dropdown-items__item"><a target="_blank"
                                                                                    ...
                                                                                    href="{{ route("public.freelancer.show", ["id" => $freelancer->id]) }}"><span
