    ...
    <main class="page-content">
        <div class="container">
            ...
            <div class="page-header">
                <h1 class="page-header__title">Companies</h1>
            </div>
                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route('admin.companies.index') }}">
                                        <span>Companies</span>
                                    </a>
                                </li>
                                                ...
                                                @foreach ($companies as $company)
                                                    <tr class="table__row">
                                                        ...
                                                        <td class="d-none d-lg-table-cell table__td">
                                                            <span class="text-grey">#{{ $company->id }}</span>
                                                        </td>
                                                        
                                                        <td class="table__td">{{ $company->name }}</td>

                                                        <td class="d-none d-sm-table-cell table__td">
                                                            <span class="text-grey">{{ $company->email }}</span>
                                                        </td>
                                                        ...
                                                        <td class="table__td text-nowrap">
                                                            <span class="text-grey">{{ \Carbon\Carbon::parse($company->created_on)->format('jS F Y') }}</span>
                                                        </td>
                                                                    ...
                                                                    <div class="dropdown-items__container">
                                                                        <ul class="dropdown-items__list">
                                                                            <li class="dropdown-items__item"><a target="_blank"
                                                                                    ...
                                                                                    href="{{ route("public.company.show", ["id" => $company->id]) }}"><span
