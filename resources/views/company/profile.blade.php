@extends('company.layouts.parent')
                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item">
                                    <a class="breadcrumbs__link" href="{{ route('companies.dashboard') }}">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route('companies.profile') }}">
                                        <span>Profile</span>
                                    </a>
                                </li>
                        ...
                        <div class="card__container">
                            <div class="card__header">
                                <div class="card__header-left">
                                    <h3 class="card__header-title">Company Info</h3>
                                </div>
                            ...
                            <div class="card__body">
                                ...
                                <div class="customer-profile__avatar" style="overflow: hidden">
                                    <img src="{{ asset($company->img ) }}" alt="" style="border-radius: 10px;height: -webkit-fill-available;">
                                ...
                                <h4 class="customer-profile__title">{{ $company->name }}</h4>
                                ...
                                <div class="card__container">
                                    <ul class="customer-profile__address">
                                        <li>
                                            ...
                                            </svg> <a href="mailto:#">{{ $company->email }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="modal__wrap">
                                    <div class="modal__window">
                                        <div class="modal__content">
                                            ...
                                            <form method="POST" action="{{ route("companies.update", $company->id) }}" id="infoForm" enctype="multipart/form-data">
                                                @csrf
                                                @method("PUT")
                                                <div class="modal__body">
                                                    <div class="modal__container">
                                                        <div class="modal-account__upload profile-upload js-profile-upload">
                                                            ...
                                                            <svg class="profile-upload__thumbnail" viewBox="0 0 252 272" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                                ...
                                                                <defs>
                                                                    ...
                                                                    <image id="profileImageAddPlaceholder" width="700" height="700" xlink:href="  {{ asset($company->img ) }}"></image>
                                                                    <image id="profileImageAdd" class="profile-upload__image" width="700" height="700" xlink:href="{{ asset($company->img ) }}"></image>
                                                                </defs>
                                                            </svg>
                                                        ...
                                                        <div class="space-upNdown input-group input-group--white input-group--prepend">
                                                            ...
                                                            <input class="input" type="text" name="name" value="{{ $company->name }}" placeholder="Name">
                                                        </div>
                                                        ...
                                                        <div class=" space-upNdown input-group input-group--white input-group--prepend">
                                                            ...
                                                            <input class="input" type="email" name="email" value="{{$company->email }}" placeholder="Email" >
                                                        </div>
                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <div class="modal__wrap">
                                    <div class="modal__window">
                                        <div class="modal__content">
                                            <div class="modal__body">
                                                <form id="bankAccountForm" action="{{ route("companies.bank_account.update", ['id' => $company->id]) }}" method="POST">
                                                    @method("PUT")
                                                    @csrf
