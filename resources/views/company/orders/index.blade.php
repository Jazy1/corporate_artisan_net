                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route('companies.orders.index') }}">
                                        <span>Orders</span>
                                    </a>
                                </li>
                                        ...
                                        <table class="table table--lines">
                                            ...
                                            <thead class="table__header">
                                                <tr class="table__header-row">
                                                    ...
                                                    <th class="table__th-sort"><span class="align-middle">Freelancer
                                                            Name</span>
                                                    </th>
                                            ...
                                            <tbody>
                                                @foreach ($orders as $order)
                                                    <tr class="table__row">
                                                        ...
                                                        <td class="table__td">{{ $order->freelancer->name }}</td>
                                                                    ...
                                                                    <div class="dropdown-items__container">
                                                                        <ul class="dropdown-items__list">
                                                                            <li class="dropdown-items__item"><a target="_blank"
                                                                                    ...
                                                                                    href="{{ route("companies.orders.show", ["id" => $order->id]) }}"><span
