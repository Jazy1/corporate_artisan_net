                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item "><a class="breadcrumbs__link"
                                        href="{{ route("companies.orders.index") }}"><span>Orders</span>
                                        <svg class="icon-icon-keyboard-right breadcrumbs__arrow">
                                            <use xlink:href="#icon-keyboard-right"></use>
                                        </svg></a>
                                </li>
                        ...
                        <div class="card__container">
                            ...
                            <ul class="card-order__customer-list">
                                <li class="card-order__customer-item">
                                    ...
                                    </svg> <b>Name:</b> <span>{{$order->freelancer->name}}</span>
                                </li>
                                {{-- <li class="card-order__customer-item">
                                ...
                                <li class="card-order__customer-item">
                                    ...
                                    </svg> <b>Email:</b> <a href="mailto:{{$order->freelancer->email}}">{{$order->freelancer->email}}</a>
                                </li>
                            </ul>
                        </div>
                    </section>
