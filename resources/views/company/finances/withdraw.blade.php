...
@section('title', 'Withdraw Money | Company')
                    ...
                    <div class="breadcrumbs">
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route("companies.finances.withdraw") }}">
                                        <span>Withdraw </span>
                                    </a>
                                </li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            withdrawButton.addEventListener('click', function () {
                ...
                fetch("{{ route('companies.finances.withdrawCash') }}", {
                    method: 'POST',
                    headers: {
                ...
                .then(result => {
                    ...
                    setTimeout(function () {
                        window.location.href = "{{ route('companies.finances.index') }}";
