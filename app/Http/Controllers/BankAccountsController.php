...
class BankAccountsController extends Controller
{
    ...
    public function updateFreelancer(UpdateBankAccountsRequest $request, BankAccounts $bankAccounts, $id){
        ...
        return redirect()->route('freelancers.profile')->with('success', 'Information updated successfully.');

    }

    public function updateCompany(UpdateBankAccountsRequest $request, BankAccounts $bankAccounts, $id){
        ...
        return redirect()->route('companies.profile')->with('success', 'Information updated successfully.');
